# -*- coding: utf-8 -*-
"""BKDS04_A11.2020.13031_OZZY PUTRA RAYHAN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZY5XbY81bOodgEgsfpi1N71m76Xqz4aM
"""
...
df = df.astype(float) #mengubah tipe data ke float
...
"""MEMBERSIHKAN DATA NULL TABEL DIATAS
...
meanthalech = df_selected['thalech'].dropna()
meanexang = df_selected['exang'].dropna()

meanTBPS = meanTBPS.astype(float)
meanChol = meanChol.astype(float)
meanfbs  = meanfbs.astype(float)
meanthalech = meanthalech.astype(float)
...
meanthalech = round(meanthalech.mean())
meanexang = round(meanexang.mean())
meanRestCG = round(meanRestCG.mean())

fill_values = {'trestbps': meanTBPS, 'chol': meanChol, 'fbs': meanfbs, 'thalech':meanthalech, 'exang':meanexang, 'restecg':meanRestCG}
...
#membagi fitur dan target menjadi data train dan test normalization
...
plt.xticks(rotation=45, ha='right') #untuk memutar label sumbu x agar mudah dibaca

#menambahkan keterangan jumlah setiap bars
for bar in bars:
	yval = bar.get_height()
